                ...
                <table class="table table-bordered">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td><a href="#" class="btn btn-primary" data-toggle="modal" data-target="#bd-example-modal-lg"
								type="button"><span class="icon-copy dw dw-email-2">
                                        Detail</span></a></td>
                        </tr>
                        <tr>
                            <th scope="row">2</th>
                                    ...
                                    <form>
                                        <div class="form-group row">
                                            <div class="col-sm-12 col-md-12">
                                                <textarea class="form-control">Isi pesan aspirasi</textarea>
                                            </div>
                                        </div>
                                    </form>
                                </div>
