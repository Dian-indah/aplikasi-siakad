...
@section('content')		
        <div class="card-box mb-30">
            ...
            <h6 class="pd-20">Bapak Ibu Guru</h6>					
            <p class="pd-20">Siakad merupakan aplikasi yang dapat membantu pihak sekolah 
                untuk mengelola nilai beserta kehadiran siswa di sekolah. Selain itu Siakad dapat
                mengelola data diri siswa.
