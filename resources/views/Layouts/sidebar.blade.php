<ul id="accordion-menu">
    @if (Auth::guard('admin')->check())  
        <li>
            <a href="{{ route('menuAdmin') }}" class="{{ (request()->is('menuAdmin')) ? 'active' : '' }} dropdown-toggle no-arrow">
                <span class="micon fa fa-home"></span><span class="mtext">Menu</span>
            </a>
        </li>       
        <li>
            <a href="{{ route('tahunAjar') }}" class="{{ (request()->is('tahunAjar')) ? 'active' : '' }} dropdown-toggle no-arrow">
                <span class="micon fa fa-calendar-check-o"></span><span class="mtext">Tahun Ajar</span>
            </a>
        </li>        
        <li>
            <a href="{{ route('kurikulum') }}" class="{{ (request()->is('kurikulum')) ? 'active' : '' }} dropdown-toggle no-arrow">
        ...
        <li>
            <a href="{{ route('mapel') }}" class="{{ (request()->is('kelas')) ? 'active' : '' }} dropdown-toggle no-arrow">
                <span class="micon fa fa-calendar-o"></span><span class="mtext">Mata Pelajaran</span>
            </a>
        </li>      
        <li>
            <a href="{{ route('masterGuru') }}" class="{{ (request()->is('masterGuru')) ? 'active' : '' }} dropdown-toggle no-arrow">
                <span class="micon fa fa-vcard"></span><span class="mtext">Guru</span>
            </a>
        </li>       
        <li>
            <a href="{{ route('kelasSiswa') }}" class="{{ (request()->is('kelasSiswa')) ? 'active' : '' }} dropdown-toggle no-arrow">
                <span class="micon fa fa-university"></span><span class="mtext">Kelas Siswa</span>
            </a>
        </li> 
        <li>
            <a href="{{ route('masterSiswa') }}" class="{{ (request()->is('masterSiswa')) ? 'active' : '' }} dropdown-toggle no-arrow">
                <span class="micon fa fa-graduation-cap"></span><span class="mtext">Siswa</span>
            </a>
        </li>
        <li>
            <a href="{{ route('ortuAdmin') }}" class="{{ (request()->is('ortuAdmin')) ? 'active' : '' }} dropdown-toggle no-arrow">
                <span class="micon fa fa-users"></span><span class="mtext">Orang Tua Siswa</span>
            </a>
        </li>
        <li>
            <a href="{{ route('pegawaiAdmin') }}" class="{{ (request()->is('pegawaiAdmin')) ? 'active' : '' }} dropdown-toggle no-arrow">
                <span class="micon fa fa-user-secret"></span><span class="mtext">Administrator</span>
            </a>
        </li>        
        <li>
            <a href="{{ route('aspirasiAdmin') }}" class="{{ (request()->is('aspirasiAdmin')) ? 'active' : '' }} dropdown-toggle no-arrow">
    ...
    @elseif (Auth::guard('guru')->check())    
        <li>
            <a href="{{route('menuGuru')}}" class="dropdown-toggle no-arrow">
                <span class="micon bi bi-house"></span><span class="mtext">Menu</span>
            </a>
        </li>    
        <li>
            <a href="{{route('nilaiGuru', Auth::guard('guru')->user()->id)}}" class="dropdown-toggle no-arrow">
                <span class="micon dw dw-notebook"></span><span class="mtext">Nilai</span>
            </a>
        </li>
        <li>
            <a href="{{route('kehadiranGuru', Auth::guard('guru')->user()->id)}}" class="dropdown-toggle no-arrow">
                <span class="micon dw dw-calendar-4"></span><span class="mtext">Kehadiran</span>
            </a>
        </li>
        <li>
