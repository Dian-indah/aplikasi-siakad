...
@section('content')
    <div class="pd-20 card-box mb-30">
        <div class="clearfix">
            <div class="pull-left">
                <h4 class="h4">Tambah Data Administrator</p>
            </div>
        </div>
        <form>
            ...
            <div class="form-group row">
                <label class="col-sm-12 col-md-2 col-form-label">Nama Administrator</label>
                <div class="col-sm-12 col-md-10">
                    <input class="form-control" type="text" placeholder="Nama Administrator" />
                </div>
            </div>
            <div class="form-group row">
